    ...
    <div class="row justify-content-center">
      <div class="col-md-8 col-lg-6 col-xl-5">
        ...
        <div class="text-center mb-3">
          ...
          <small style="color: #9baaaa">Please fill in the information below.</small>
        </div>
        ...
        <form action="../validation/signup.php" method="post" novalidate class="data-form">
          ...
          <div class="mb-1">
            <div class="data-input">
              ...
              <input type="text" class="form-control" placeholder="Username" value="<?php echo (isset($_GET['username'])) ? $_GET['username'] : "" ?>" name="username" autocomplete="off" />
            </div>
          </div>
          ...
          <div class="mb-1">
            <div class="data-input">
              <i class="bx bxs-envelope fs-5" style="color: #9baaaa"></i>
              <input type="text" class="form-control" placeholder="Email" name="email" value="<?php echo (isset($_GET['email'])) ? $_GET['email'] : "" ?>" autocomplete="off" />
            </div>
          </div>
          ...
          <div class="mb-1">
            <div class="data-input">
              <i class="bx bxs-building fs-5" style="color: #9baaaa"></i>
              <input type="text" class="form-control" placeholder="Department name" value="<?php echo (isset($_GET['department'])) ? $_GET['department'] : "" ?>" name="department" autocomplete="off" />
            </div>
          </div>
          ...
          <div class="mb-1">
            <div class="data-input">
              ...
              <i class="bx bx-low-vision fs-5" id="eye"></i>
            </div>
          </div>
        ...
        <div class="text-center">
          <small style="color: #9baaaa">
            ...
            <a href="login.php" class="text-decoration-none" style="color: #f7770f">Login</a>
          </small>
        </div>
