    ...
    <div class="row justify-content-center">
      <div class="col-md-8 col-lg-6 col-xl-5">
        ...
        <div class="text-center mb-4">
          ...
          <small style="color: #9baaaa">We will send you an email to reset your password</small>
        </div>
        ...
        <div class="text-center">
          <small>
            <a href="register.php" class="text-decoration-none" style="color: #9baaaa">Back to sign in</a>
          </small>
        </div>
