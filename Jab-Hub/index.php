            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#goals">Our Goal</a></li>
...
<section class="py-5" id="goals">
  <div class="container my-5">
      <div class="row justify-content-center">
        ...
        <!-- About section-->
        <section class="py-5" style="background-color: #DBE2E9;" id="about">
            <div class="container my-5">
                <div class="row justify-content-center">
                    <div class="col-lg-4">
...
<!-- Footer -->
<footer class="text-center text-lg-start" style="background-color: #3E505C; color: whitesmoke;" id="contact">
