            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item"><a class="nav-link" href="admin.php">Home</a></li>
                        <li class="nav-item"><a class="nav-link" href="admin.php#eventPost">Announcement</a></li>
...
$sql = "SELECT id, username, email, department, password FROM users";
$search_query = '';
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="../employee-crud/view.php?id=<?php echo $row['id']; ?>" class="btn btn-info text-sm">View</a>
                                    <a href="../employee-crud/edit.php?id=<?php echo $row['id']; ?>" class="btn btn-success text-sm">Edit</a>
                            <form action="../employee-crud/delete.php" method="POST" class="d-inline">
                              <button type="submit" name="delete" value="<?= $row['id']; ?>" class="btn btn-danger text-sm">Delete</button>
                            </form>    
                            </td>
                        </tr>
                        <?php
